      ...
      <div className=" flex items-center justify-between w-full px-5">
        <div className=" flex items-center gap-5">
          ...
          >
            ...
            />
            <div className=" absolute right-1 top-1 blur-theme-effect bg-white text-black text-xs px-1 rounded">${price}</div>
          </div>
          <div className=" grid items-center gap-4 ">
            ...
            <div className=" flex items-center justify-around w-full">
              <button type="button"  onClick={onDecreaseItemQTY}className=" bg-theme-cart rounded h-6 w-6 lg:w-5 lg:h-5 flex items-center justify-center active:scale-90">
              ...
              <button type="button" onClick={onIncreaseItemQTY} className="bg-theme-cart rounded h-6 w-6 lg:w-5 lg:h-5 flex items-center justify-center active:scale-90">
