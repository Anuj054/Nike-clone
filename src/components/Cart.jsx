    ...
    <>
     ...
     w-full h-screen opacity-100 z-[250] ${
       ifCartState
         ...
         : "opacity-0 hidden translate-x-8"
     }`}
      >
        <div
        ...
        >
          ...
          {CartItem?.length === 0 ? (
            ...
            <div>
              ...
              gap-y-7 lg:gap-y-5 overflow-x-scroll h-[81vh] scroll-smooth scroll-hidden py-3">
              ...
              <div className=" fixed bottom-0  bg-white w-full px-5 py-2 grid items-center">
                ...
                <div className=" grid items-center gap-2 ">
                  <p className=" text-sm font-medium text-center">Taxes and Shipping Will 
